...
const Homepage = ()=>{
    ...
    return(
        <div className='homepage'>
            ...
            {  (<img className='portrait' alt='portrait' src='https://scontent.fymq2-1.fna.fbcdn.net/v/t1.6435-9/203434578_1881649052014463_5108897948529942915_n.jpg?_nc_cat=105&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=4i0ORZUiS2EAX9XwvkU&_nc_ht=scontent.fymq2-1.fna&oh=df65860c6f4c47d054a9915c5552b1ea&oe=6198C41D'/>)}
            </div>
            <div className='div-2'>
